...
public class Intermediate_first_question extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        navbar = (TextView) findViewById(R.id.intermediate_first_question_menu_bar);
...
//        }
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        else if (id == R.id.Logout)
        {
            ...
            Intent i = new Intent(Intermediate_first_question.this,Signin_Activity.class);
